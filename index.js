...
break
case 'scbot':
reply('GAK ADA SC CARI DI YOUTUBE SANA')
break
case 'runtime':
...
Lexxy.sendMessage(from, asupan, video, {quoted: mek, caption: 'SUBSCRIBE VANZZ OFC'})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: 'SUBSCRIBE VANZZ OFC'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: 'SUBSCRIBE VANZZ OFC'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: 'SUBSCRIBE VANZZ OFC '})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: 'SUBSCRIBE VANZZ OFC ',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: 'SUBSCRIBE VANZZ OFC '})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `SUBSCRIBE VANZZ OFC `, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
Lexxy.sendMessage(from, girlneko, image, {caption: `SUBSCRIBE VANZZ OFC `, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
